  ...
  const menuItemsPengurus = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Data Tahsin Month",
          icon: "fa-solid fa-book-open",
          path: "/guru/tahsin/month",
          action: [""],
        },
        {
          title: "Data Tahsin Week",
          icon: "fa-solid fa-book-open",
          path: "/guru/tahsin/week",
          action: [""],
        },
        {
          title: "Data Tahsin Year",
          icon: "fa-solid fa-book-open",
    ...
    },
    {
      ...
      items: [
        ...
        {
          title: "Data Kitab Month",
          icon: "fa-solid fa-book-open",
          path: "/guru/kitab/month",
          action: [""],
        },
        {
          title: "Data Kitab Week",
          icon: "fa-solid fa-book-open",
          path: "/guru/kitab/week",
          action: [""],
        },
        {
          title: "Data Kitab Year",
          icon: "fa-solid fa-book-open",
          path: "/guru/kitab/year",
          action: [""],
        },
        {
