...
function StatusBarangInventaris() {
  ...
  const deleteData = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${API_DUMMY}/api/admin/status_barang/` + id, {
            headers: {
              "auth-tgh": `jwt ${localStorage.getItem("tokenpython")}`,
            },
          })
  ...
  const add = async (e) => {
    ...
    try {
      await axios.post(`${API_DUMMY}/api/admin/status_barang`, data, {
        headers: {
          "auth-tgh": `jwt ${localStorage.getItem("tokenpython")}`,
        },
      });
        ...
        >
          ...
          <div className="main-card box-tabel mb-3 card">
            <div className="card-header" style={{ display: "flex" }}>
              <p className="mt-3">Status Barang</p>
...
export default StatusBarangInventaris;
