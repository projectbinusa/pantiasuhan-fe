  ...
  const getAll = async (page) => {
    try {
      const response = await axios.get(
        `${API_DUMMY}/pantiasuhan/api/foto_kegiatan/all/terbaru?page=${page - 1
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                          <button
                            ...
                            <a
                              ...
                              href={`/edit_foto_kegiatan/${berita.id}`}>
...
export default FotoKegiatanPanti;
