    ...
    const getAll = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_DUMMY_BYRTGHN}/api/member/hafalan-kitab/rekap-weakly/organization`,
                config
            );
                ...
                >
                    ...
                    <div className="main-card box-tabel mb-3 card">
                        <div className="card-header" style={{ display: "flex" }}>
                            <p className="mt-3">Daftar Rekap Hafalan Kitab Weakly</p>
