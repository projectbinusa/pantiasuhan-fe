    ...
    const getAll = async () => {
        try {
            ...
            const response = await axios.get(
                `${API_DUMMY_BYRTGHN}/api/member/hafalan-kitab/rekap-year/member`,
                config
            );
                ...
                <div className="container box-table mt-3 app-main__outer" data-aos="fade-left">
                    ...
                    <div className="main-card box-tabel mb-3 card">
                        <div className="card-header" style={{ display: "flex" }}>
                            <p className="mt-3">Daftar Rekap Hafalan Kitab Year</p>
                                        ...
                                        filteredList.map((hafalanKitab, no) => {
                                            return (
                                                <tr key={no}>
                                                    ...
                                                    <td className="text-md-start text-end">
                                                        {hafalanKitab.page_start} - {hafalanKitab.page_end}
                                                    </td>
                                                    <td className="text-md-start text-end">
