...
function DataTahfidzDaily() {
  ...
  const getAll = async () => {
    try {
      ...
      if (!userData.organization_id || !date) return;
      ...
      const response = await axios.get(
        `${API_DUMMY_BYRTGHN}/api/member/tahfidz/rekap-daily/organization`,
        config
      );
        ...
        >
          ...
          <div className="main-card box-tabel mb-3 card">
            <div className="card-header" style={{ display: "flex" }}>
              <p className="mt-3">Daftar Rekap Tahfidz Daily</p>
...
export default DataTahfidzDaily;
