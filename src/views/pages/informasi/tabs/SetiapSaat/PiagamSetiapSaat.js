    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `${API_DUMMY}/bawaslu/api/jenis-keterangan/14/isi-informasi?page=0&size=10&sortBy=id&sortOrder=desc`
        );
...
export default PiagamSetiapSaat;
