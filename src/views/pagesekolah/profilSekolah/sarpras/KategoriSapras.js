        ...
        <div>
            <div>
                ...
                <ul className="category-berita">
                    ...
                    <li><a href="/ruang-kantor">Ruang Kantor</a></li>
                    <hr style={{ width: '100%', border: '0', borderTop: '2px dotted #002147', color: '#002147' }} />
                    <li><a href="/ruang-kelas">Ruang Kelas</a></li>
                    <hr style={{ width: '100%', border: '0', borderTop: '2px dotted #002147', color: '#002147' }} />
                    <li><a href="/ruang-lab">Ruang Laboratorium</a></li>
                    <hr style={{ width: '100%', border: '0', borderTop: '2px dotted #002147', color: '#002147' }} />
                    <li><a href="/sarana-olahraga">Sarana Olahraga</a></li>
                    <hr style={{ width: '100%', border: '0', borderTop: '2px dotted #002147', color: '#002147' }} />
                    <li><a href="/sarana-ibadah">Sarana Ibadah</a></li>
                    <hr style={{ width: '100%', border: '0', borderTop: '2px dotted #002147', color: '#002147' }} />
                    <li><a href="/sarana-kesehatan">Sarana Kesehatan</a></li>
                    <hr style={{ width: '100%', border: '0', borderTop: '2px dotted #002147', color: '#002147' }} />
                    <li><a href="/sarana-protokol-kesehatan">Sarana Protokol Kesehatan</a></li>
                </ul>
            </div>
            <br />
            <div>
