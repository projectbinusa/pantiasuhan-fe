...
function RuangKelas() {
    ...
    const getAllSapras = async () => {
        try {
            const response = await axios.get(`${API_DUMMY}/smpn1bergas/api/sarana/all/category?category=Ruang%20Kelas&page=0&size=1`);
    ...
    const getAllSaprasFoto = async (page = 1) => {
        try {
            const response = await axios.get(`${API_DUMMY}/smpn1bergas/api/sarana/all/category?category=Ruang%20Kelas&page=${page - 1}&size=1`);
            ...
            <main className="container-sapras">
                <div className='header-sapras'>
                    <ul>
                        ...
                        <li><i class="fas fa-angle-right"></i> Ruang Kelas </li>
                    </ul>
                </div>
