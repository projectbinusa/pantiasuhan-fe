...
function SaranaOlahraga() {
    ...
    const getAllSapras = async () => {
        try {
            const response = await axios.get(`${API_DUMMY}/smpn1bergas/api/sarana/all/category?category=Sarana%20Olahraga&page=0&size=1`);
            ...
            <main className="container-sapras">
                <div className='header-sapras'>
                    <ul>
                        ...
                        <li><i class="fas fa-angle-right"></i> Sarana Olahraga </li>
                    </ul>
                </div>
